...
#include "stanExports_lc_beta_prior_good.h"

RCPP_MODULE(stan_fit4lc_beta_prior_good_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_lc_beta_prior_good")
