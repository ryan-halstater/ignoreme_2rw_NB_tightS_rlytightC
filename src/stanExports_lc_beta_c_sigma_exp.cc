...
#include "stanExports_lc_beta_c_sigma_exp.h"

RCPP_MODULE(stan_fit4lc_beta_c_sigma_exp_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_lc_beta_c_sigma_exp")
